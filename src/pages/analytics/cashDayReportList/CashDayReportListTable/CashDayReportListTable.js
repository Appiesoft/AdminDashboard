...
import './CashDayReportListTable.css'
import FormInput from "../../../../components/FormInput"
import CashDayReportForm from '../CashDayReportForm/CashDayReportForm';
import { useSelector, useDispatch } from 'react-redux';
import { cashDayReportList } from '../../../../redux/analytics/cashDayReport/action';
import ShowHide from '../../cashDayReportList/CashDayReportListTable/model/showHideColumns/ShowHide'
...
const CashDayReportListTable = ({ TableShowBtn }) => {
    const dispatch = useDispatch();
    const store = useSelector((state) => state)
    const cashDayReportListData = store?.CashDayReportList?.cashDayReport?.data
    const paginationValues = store?.CashDayReportList?.cashDayReport?.meta?.pagination
    const cashDayReportListLoader = store.CashDayReportList;
    ...
    if (cashDayReportListData) {
        headers = DynamicHeaders(cashDayReportListData, ['emp_id']);
    }
    ...
    const handleGeneratePdf = () => {
        var dataLists = cashDayReportListData
    ...
    const getChecKBoxData = () => {
        const arr = cashDayReportListData
    ...
    const parentCashDayReportTable = (item) => {
                ...
                <Col xs={12}>
                    <Card>
                        <Card.Body className='pt-0'>
                            ...
                            <Row>
                                <Col>
                                    <CashDayReportForm isOpen={isOpen} parentCashDayReportTable={parentCashDayReportTable} closeIsopen={closeIsopen} />
                                </Col>
                            </Row>
                            {cashDayReportListLoader.loading ? <MainLoader /> : <>
                                <Row >
                                    <Col className='overflow-auto table_container'>
                                        <Table className="mb-0" size="sm">
                                            ...
                                            <tbody>
                                                {cashDayReportListData?.map((item, index) => {
                                                    return (
...
export default CashDayReportListTable

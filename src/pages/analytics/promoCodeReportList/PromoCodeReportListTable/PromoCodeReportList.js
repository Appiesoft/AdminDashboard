...
import './PromoCodeReportList.css'
import PromoCodeReportForm from '../PromoCodeReportForm/PromoCodeReportForm';
import { useSelector, useDispatch } from 'react-redux';
import { PromoCodeReportListAction } from '../../../../redux/actions';
import ShowHide from '../PromoCodeReportListTable/model/showHideColumns/ShowHide';
...
const PromoCodeReportList = () => {
    const dispatch = useDispatch();
    const store = useSelector((state) => state)
    const promoCodeReportListData = store?.PromoCodeReportList?.promoCodeReportList?.data
    const paginationValues = store?.PromoCodeReportList?.promoCodeReportList?.meta?.pagination
    const promoCodeReportListLoader = store.PromoCodeReportList;
    ...
    if (promoCodeReportListData) {
        headers = DynamicHeaders(promoCodeReportListData, ['emp_id']);
    }
    ...
    const handleGeneratePdf = () => {
        var dataLists = promoCodeReportListData
    ...
    const getChecKBoxData = () => {
        const arr = promoCodeReportListData
    ...
    const parentPromoCodeListTable = (item) => {
    ...
    useEffect(() => {
        dispatch(PromoCodeReportListAction({
                ...
                <Col xs={12}>
                    <Card>
                        <Card.Body className='pt-0'>
                            ...
                            <Row>
                                <Col>
                                    <PromoCodeReportForm isOpen={isOpen} parentPromoCodeListTable={parentPromoCodeListTable} toggle={toggle} />

                                </Col>
                            </Row>
                            {promoCodeReportListLoader.loading ? <MainLoader /> : <>
                                <Row >
                                    <Col className='overflow-auto table_container'>
                                        <Table className="mb-0" size="sm">
                                            ...
                                            <tbody>
                                                {promoCodeReportListData?.map((item, index) => {
                                                    return (
...
export default PromoCodeReportList

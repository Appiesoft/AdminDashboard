...
import './TaxCollectionReportListTable.css'
import FormInput from "../../../../components/FormInput"
import TaxCollectionReportForm from '../TaxCollectionReportForm/TaxCollectionReportForm';
import { useSelector, useDispatch } from 'react-redux';
import { TaxCollectionReportList } from '../../../../redux/analytics/taxCollectionReport/action';
import ShowHide from '../../taxCollectionReportList/TaxCollectionReportListTable/model/showHideColumns/ShowHide'
...
const TaxCollectionReportListTable = () => {
    const dispatch = useDispatch();
    const store = useSelector((state) => state)
    const taxCollectionReportData = store?.TaxCollectionReportList?.taxCollectionReportList?.data
    const paginationValues = store?.TaxCollectionReportList?.taxCollectionReportList?.meta?.pagination
    const taxCollectionReportListLoader = store.TaxCollectionReportList;
    ...
    if (taxCollectionReportData) {
        headers = DynamicHeaders(taxCollectionReportData, ['emp_id']);
    }
    ...
    const handleGeneratePdf = () => {
        var dataLists = taxCollectionReportData
    ...
    const getChecKBoxData = () => {
        const arr = taxCollectionReportData
    ...
    const parentTaxCollectionReportTable = (item) => {
    ...
    }, [page, showLimit, searchText, dateStart, dateEnd, store_Id])
                ...
                <Col xs={12}>
                    <Card>
                        <Card.Body className='pt-0'>
                            ...
                            <Row>
                                <Col>
                                    <TaxCollectionReportForm isOpen={isOpen} parentTaxCollectionReportTable={parentTaxCollectionReportTable} toggle={toggle} />
                                </Col>
                            </Row>

                            {taxCollectionReportListLoader.loading ? <MainLoader /> : <>
                                <Row >
                                    <Col className='overflow-auto table_container'>
                                        <Table ref={componentRef} className="mb-0 " size="sm">
                                            ...
                                            <tbody>
                                                {taxCollectionReportData?.map((item, index) => {
                                                    return (
...
export default TaxCollectionReportListTable
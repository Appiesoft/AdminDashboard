...
import { ProducttList } from '../../../../redux/analytics/productList/action';
import ShowHide from '../ProductListTable/model/showHideColumns/ShowHide';
...
const ProductListTable = () => {
    ...
    const productListData = store?.ProductList?.productList?.data
    const paginationValues = store?.ProductList?.productList?.meta?.pagination
    const productListLoader = store?.ProductList;
    ...
    if (productListData) {
        headers = DynamicHeaders(productListData, ['emp_id']);
    }
    ...
    const parentProductListTable = (item) => {
                ...
                <Col xs={12}>
                    <Card>
                        <Card.Body className='pt-0'>
                            ...
                            <Row>
                                <Col>
                                    <ProductListForm isOpen={isOpen} parentProductListTable={parentProductListTable} toggle={toggle} />
                                </Col>
                            </Row>
                            {productListLoader.loading ? <MainLoader /> : <>
                                <Row >

...
import PatternListTable from './patternList/PatternListTable';
import NewEnteryForm from './newEnteryPattern/NewEnteryForm';
const Index = () => {
        ...
        <>
            <Row>
                <Col>
                    ...
                    <h4 className="page-title">{!componentShow ? "Pattern List " : "New Entry"}</h4>
                </Col>
            </Row>
            <Row >
                <Col>
                    {!componentShow ? <PatternListTable TableShowBtn={TableShowBtn} /> : <NewEnteryForm TableShowBtn={TableShowBtn} />}
                </Col>
            </Row>
        </>)
}

...
import ColorListTable from './colorList/ColorListTable';
import NewEnterForm from './newEnterColor/NewEnterForm';
        ...
        <>
            <Row>
                <Col>
                    ...
                    <h4 className="page-title">{!componentShow ? "Color List " : "New Entry"}</h4>
                </Col>
            </Row>
            <Row >
                <Col>
                    {!componentShow ? <ColorListTable TableShowBtn={TableShowBtn} /> : <NewEnterForm TableShowBtn={TableShowBtn} />}
                </Col>
            </Row>
        </>)
}

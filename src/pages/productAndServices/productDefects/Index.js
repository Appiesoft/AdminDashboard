...
import DeffectListTable from './defectList/DefectListTable';
import NewEnterDefectList from './newEnterDefect/NewEnterDefectListForm';
        ...
        <>
            <Row>
                <Col>
                    ...
                    <h4 className="page-title">{!componentShow ? "Defect List " : "New Entry"}</h4>
                </Col>
            </Row>
            <Row >
                <Col>
                    {!componentShow ? <DeffectListTable TableShowBtn={TableShowBtn} /> : <NewEnterDefectList TableShowBtn={TableShowBtn} />}
                </Col>
            </Row>
        </>)
}

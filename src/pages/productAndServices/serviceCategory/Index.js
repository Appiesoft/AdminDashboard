        ...
        <>
            <Row>
                <Col>
                    ...
                    <h4 className="page-title">{!componentShow ? "Service Category List" : "New Entry"}</h4>
                </Col>
            </Row>
            <Row >
                <Col>
                    {!componentShow ? <ServiceCategoryList TableShowBtn={TableShowBtn} /> : <NewEnteryForm TableShowBtn={TableShowBtn} />}
                </Col>
            </Row>
        </>
    )

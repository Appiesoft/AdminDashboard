...
import UpChargesListTable from './upChargesList/UpChargesListTable';
import NewEnteryForm from './newEnteryUp/NewEnteryForm'
        ...
        <>
            <Row>
                <Col>
                    ...
                    <h4 className="page-title">{!componentShow ? "UpCharges List" : "New Entry"}</h4>
                </Col>
            </Row>
            <Row >
                <Col>
                    {!componentShow ? <UpChargesListTable TableShowBtn={TableShowBtn} /> : <NewEnteryForm TableShowBtn={TableShowBtn} />}
                </Col>
            </Row>
        </>)
}

...
import ProductCategoryList from './productCategoryList/ProductCategoryListTable'
import NewProductCategory from './newProductCategory/NewProductCategoryForm'
        ...
        <>
            <Row>
                <Col>
                    ...
                    <h4 className="page-title">{!componentShow ? "Product Category List" : "New Product Category"}</h4>
                </Col>
            </Row>
            <Row >
                <Col>
                    {!componentShow ? <ProductCategoryList TableShowBtn={TableShowBtn} /> : <NewProductCategory TableShowBtn={TableShowBtn} />}
                </Col>
            </Row>
        </>)
}

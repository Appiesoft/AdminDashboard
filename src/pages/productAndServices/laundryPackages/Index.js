...
import NewEnterLaundryForm from './newEnteryForm/NewEnterLaundryForm';
import PackageListTable from './packageList/PackageListTable';
        ...
        <>
            <Row>
                <Col>
                    ...
                    <h4 className="page-title">{!componentShow ? "Package List" : "New Entry"}</h4>
                </Col>
            </Row>
            <Row >
                <Col>
                    {!componentShow ? <PackageListTable TableShowBtn={TableShowBtn} /> : <NewEnterLaundryForm TableShowBtn={TableShowBtn} />}
                </Col>
            </Row>
        </>)
}

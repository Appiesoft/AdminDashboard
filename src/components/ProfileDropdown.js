...
import AdminProfile from '../../src/assets/images/users/adminProfile.png'
        ...
        <Dropdown show={dropdownOpen} onToggle={toggleDropdown}>
            <Dropdown.Toggle
                ...
                <span className="account-user-avatar">
                    ...
                    <img src={AdminProfile} className="rounded-circle" alt="user" />
                </span>
                <span>
                    <span className="account-user-name">{props.username} {props.userTitle}</span>

...
const MenuItemWithChildren = ({ item, linkClassName, subMenuClassNames, activeMenuItems, toggleMenu }) => {
    ...
    const leftSidebar = useSelector((state) => state.Layout.leftSideBarType);
        ...
        <li className={classNames('side-nav-item', { 'menuitem-active': open })}>
            ...
            <Collapse in={open}>
                <ul
                    ...
                    style={{
                        position:
                            (item.label === 'Promotion' && leftSidebar === 'condensed' && 'absolute') ||
                            (item.label === 'Apps' && leftSidebar === 'condensed' && 'absolute') ||
                            (item.label === 'Analytics' && leftSidebar === 'condensed' && 'absolute'),
                        bottom:
                            (item.label === 'Promotion' && leftSidebar === 'condensed' && '54px') ||
                            (item.label === 'Apps' && leftSidebar === 'condensed' && '54px') ||
                            (item.label === 'Analytics' && leftSidebar === 'condensed' && '54px'),
                    }}>
